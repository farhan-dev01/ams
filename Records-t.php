                        ...
                        <form class="filterForm col-md-8" method="POST" action="#">
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input class="form-control round monthEnd dateIcon date-picker2" readonly type="text"  id="monthEnd" name="date" placeholder=""
                                           value="<?php
                                           $d = explode(' ', date('F Y'));
                                           $month = $d[0];
                                           $year = $d[1];
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="name" class="form-control round" style="height: 3.0em;">
                                        <?php
                                        ...
                                        $conn = opencon();
                                        {
                                            ...
                                            while ($result = mysqli_fetch_array($query)) {
                                                $d = $result['date'];
                                                ?>
                                                <option value="<?php echo $result['ename']; ?>"
                            ...
                            <div id="page">
                                ...
                                $conn = opencon();
                                {
                                    ...
                                    if (isset($_POST['submit']) && isset($_POST['name'])) {
                                        ...
                                        $q="SELECT employee.*,department.dname FROM employee join department on employee.deptno=department.deptno where department.dname like '%" . $dname . "%'order by employee.eid limit $start,$per_page";
                                        $query = mysqli_query($conn,
                                            $q) or
...
type="hidden" value="'.date_format(date_sub(date_create($dateglobal), date_interval_create_from_date_string('1 months')),'Y-m').'-26'.'" name="dateRange" /> ';
            ...
            <?php if(isset($_POST['submit']) || isset($_POST['date']))
            {
            ?>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <form action = "#">
                                    ...
                                    <a  id= "exp" href="ExportToExcel/Export.php?year=<?php echo date('Y'); ?>&dname=<?php echo $dname?>" class="btn btn-success roundBtn" data-window="external" data-dismiss="modal" >Export</a>
