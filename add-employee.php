            ...
            <div class="card-body">
                ...
                <div class="form-group">
                 ...
                 <!-- 
                  ...
                  <select name="department" required id="dept" >
               ...
               while ($result=mysqli_fetch_array($query))
                  {?>
                  <option value="<?php echo $result['deptno']; ?>"><?php echo $result['dname']; ?></option>
                  <?php
                  }
                  ?>
                  </select>
...
if($count==1)
{
 ...
 $(\'#myModalsu\').modal({
    ...
    if (move_uploaded_file($_FILES['pic']['tmp_name'], $mImage)) {
        $query =
            "Insert into employee(eid,ename,eqid,eimage,deptno) values ('$id','$name','$qid','$mImage','$department')";
