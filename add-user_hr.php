  ...
  <header>
    ...
    <section class="pageContent container h-75">
      ...
      <section class="pageTitle row">
        <div class="col-md-12">
          <h3 class="text-capitalize">Add HR Manager</h3>
        </div>
      </section><!-- Page Title-->
            ...
            <div class="card-body">
                ...
                <input hidden="hidden" type="file" onchange="readURL(this);" name="pic" id="fileUpload" accept="image/*">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control round" type="password" id="password" name="password" placeholder="password" maxlength="10" required  value="<?php echo (isset($_POST['password'])? $_POST['password'] : ''); ?>">
...
$query1 = mysqli_query($conn, "SELECT username FROM hr_user where username='$username'") or die(mysqli_error($conn));
...
$query="Insert into hr_user(name,username,password,email,image) values ('$name','$username','$password','$email','$mImage')";
