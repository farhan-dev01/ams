...
<header>
<?php 
 require_once 'header_department.php';
  ?>
  <?php
...
$sno = $start + 1;
   ...
   ?>
        ...
        <section class="pageTitle row">
            ...
            <div class="col-md-2">
                <a href="javascript:void(0)" onclick="window.location.href='add-employee-t.php'" class="btn btn-primary roundBtn float-right">+ ADD EMPLOYEE</a>
            </div>
        </section><!-- Page Title-->
 ...
 $conn=opencon();
 {
	 ...
	 $query = mysqli_query($conn, "SELECT employee.*,department.dname FROM employee join department on employee.deptno=department.deptno where employee.deptno= '$dept' order by employee.eid limit $start,$per_page") or die(mysqli_error($conn));
 while ($result=mysqli_fetch_array($query))
    {
        ...
        <form>
                    <li class="tex-center row align-items-center justify-content-center bg-white round boxShadow">
                        ...
                        <a class="col-sm-1 col-md-1 col-lg-1 col-xl-1 align-self-center text-center" href="edit-employee-t.php?id=<?php echo $result['eid'] ?>;"><img src="content/img/edit.png" class="" alt="" /></a>
                        <a class="col-sm-1 col-md-1 col-lg-1 col-xl-1 align-self-center text-center" href="" onclick = "document.getElementById('sid').value =  <?php echo $result['eid'] ?>;"
