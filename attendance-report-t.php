        ...
        <div class="filterSection">
            <div class="container">
                <div class="row">
                    ...
                    <form class="filterForm col-md-8" method="POST" action="attendance-report-t.php">
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label for="monthEnd">Month</label>
                                <input class="form-control round monthEnd dateIcon date-picker" name="date" readonly
                                       type="text"
                                       value="<?php echo isset($_GET['date']) ? $_GET['date'] : date('F Y'); ?>"
                                       id="dt" placeholder="" onchange="this.form.submit();">
                            </div>
                            <div class="form-group col-md-4">
                        ...
                        <div class="btnWrap">
                            ...
                            <button type="submit" name="submit" class="btn btn-primary roundBtn applyBtn abc">Apply
                            </button>
