    ...
    try {
        ...
        foreach ($_POST['eid'] as $eid) {
            ...
            foreach ($_POST['status' . $eid] as $status) {
                ...
                $query =
                    mysqli_query($conn, ("UPDATE  attendance set status = '$status' WHERE eid = '$eid' and date = '$date'"));
    ...
    try {
        ...
        foreach ($_POST['eid'] as $eid) {
            ...
            for($i=1;$i<=$datediff1;$i++) {
                ...
                $query =
                    mysqli_query($conn, ("delete from  attendance where  date = '$date' and eid='$eid'"));
...
<!--                                        <option value="" disable selected> -- Select --</option>-->
                            ...
                            applyBtn">Cancel
                                ...
                                <button type="submit"  onclick="if($('.select-styled:eq(0)').text()!='--Select--'){}else{window.location.assign('edit-attendance-t.php');return false;}" name="submit" class="btn btn-primary roundBtn applyBtn">Apply
                                </button>
            ...
            <form method="get" id = "form" >
                <section class="pageTitle row">
                    <div class="col-md-4">
                        <h3 class="d-inline">Edit Attendance</h3>
                    </div><!-- md12 -->
            ...
            <form method="post" id="for-del">
                <section class="">
                    <section class="blockSection ">
                        ...
                        <div class="form-group text-center">
                            <button class="btn btn-primary px-5 border-0 roundBtn" type="sumbit" name="btnsave">UPDATE
                            </button>
                            <button class="btn btn-primary px-5 border-0 roundBtn" data-toggle="modal" data-target="#myModal" type="button" id="del" name="del">DELETE
                            </button>
                        </div>
                ...
                <div class="modal" id="myModal">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <form action = "#">
                                    <input type="submit" onclick="document.getElementById('#for-del').submit();" class="btn btn-danger roundBtn" name="delete"  value = "Yes"/>
                ...
                .getElementById('a'+inputname).className = 'icon absentIcon';}else{}" id="absent" name="markAttendance"/>
                            <label class="absent" for="absent">Absent</label>

                            <input type="radio" onchange="if(this.checked){document.getElementById(inputname).value =
                'workingOnSite'; this.checked = false;$('#JPO').popup('hide') ;document
                .getElementById('a'+inputname).className = 'icon workingOnSiteIcon';}else{}" id="workingOnSite" name="markAttendance"/>
                            <label  class="workOnSite"  class="" for="workingOnSite">Work on Site</label>

                            <input type="radio" onchange="if(this.checked){document.getElementById(inputname).value =
                'unPaidLeave'; this.checked = false;$('#JPO').popup('hide') ;document
                .getElementById('a'+inputname).className = 'icon unPaidLeaveIcon';}else{}" id="unPaidLeave" name="markAttendance"/>
                            <label  class="unpaidLeave"  for="unPaidLeave">Unpaid Leave</label>

                            <input type="radio" onchange="if(this.checked){document.getElementById(inputname).value =
                'weeklyOff'; this.checked = false;$('#JPO').popup('hide') ;document
                .getElementById('a'+inputname).className = 'icon weeklyOffIcon';}else{}" id="weeklyOff" name="markAttendance" />
                            <label  class="weeklyOff"  for="weeklyOff">Weekly Off</label>

                            <input type="radio" onchange="if(this.checked){document.getElementById(inputname).value =
                'maternityLeave'; this.checked = false;$('#JPO').popup('hide') ;document
                .getElementById('a'+inputname).className = 'icon maternityLeaveIcon';}else{}" id="maternityLeave" name="markAttendance" />
                ...
                .getElementById('a'+inputname).className = 'icon annualLeaveIcon';}else{}" id="annualLeave" name="markAttendance" />
                            <label  class="annualLeave"  for="annualLeave">Annual Leave</label>

                            <input type="radio" onchange="if(this.checked){document.getElementById(inputname).value =
                'compassionate'; this.checked = false;$('#JPO').popup('hide') ;document
                .getElementById('a'+inputname).className = 'icon compassionateIcon';}else{}" id="compassionate" name="markAttendance" />
                            <label  class="compassionate"  for="compassionate">Compassionate</label>

                            <input type="radio" onchange="if(this.checked){document.getElementById(inputname).value =
                'sickLeave'; this.checked = false;$('#JPO').popup('hide') ;document
                .getElementById('a'+inputname).className = 'icon sickLeaveIcon';}else{}" id="sickLeave" name="markAttendance"/>
                            <label  class="sickLeave"  for="sickLeave">Sick Leave</label>

                            <input type="radio" onchange="if(this.checked){document.getElementById(inputname).value =
                'paternityLeave'; this.checked = false;$('#JPO').popup('hide') ;document
                .getElementById('a'+inputname).className = 'icon paternityLeaveIcon';}else{}" id="paternityLeave" name="markAttendance"/>
                ...
                .getElementById('a'+inputname).className = 'icon businessTripIcon';}else{}" id="businessTrip" name="markAttendance"/>
...
<script>
    ...
    //                     $(".select:eq(1)").remove();
    //
    //                     $("#empDiv").append('<select id="emp" name="name" hidden><option value="" disable selected> -- Select --</option>');
    //
    //                     // $("#emp").append("<option value='0'>Select</option>");
    //
    //                     for (var i = 0; i < len; i++) {
    //                         // alert('sadas');
