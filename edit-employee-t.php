                ...
                <div class="card-body">
                    ...
                    <form class="mt-4 align-items-center" enctype="multipart/form-data" action="#" method="POST" >
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control round" required maxlength="6" type="text" id="employeeId" name="employeeId" placeholder="" value="<?php echo $result['eid']?>" pattern="[0-9]+">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control round" required type="text" maxlength="11" id="qid" name="QatarId" placeholder="" value="<?php echo $result['eqid'] ?>" pattern="[0-9]+">
                        </div>
                        <div class="form-group">
                            <label for="departmentName">Department</label>
                            <input class="form-control round" required readonly type="text" id="dept" name="dept" placeholder="" value="<?php echo $dname ?>">
                        </div>
...
//if image is chnaged
    ...
    {
        $query="update employee set  eid='$eid',ename='$name',eqid='$qid',eimage='$image' where eid='$chid'";
...
//if image is not chnaged
    ...
    {
        $query="update employee set  eid='$eid',ename='$name',eqid='$qid',eimage='$img' where eid='$chid'";
        if(!mysqli_query($conn,$query))
        {
            echo  '<div class="modal" id="myModalsu">
    <div class="modal-dialog">
