        ...
        <section class="pageContent container">
            ...
            <form method="get" id = "form" action="#"  >
                ...
                <div class="form-group col-md-4 monthWrap">
                    <input type="hidden" name="s2" value="<?php echo $_GET['s2'];?>"/>
                            ...
                            <div id="page">
                                ...
                                if (isset($_GET['s2'])) {
                                    ...
                                    $query = mysqli_query($conn,
                                        "SELECT e.* from employee as e where e.ename like '%" . $ename . "%' and e.deptno like '%" . $dept . "%'");
                                } else {
                                    $query = mysqli_query($conn,
                                        "SELECT employee.*,department.dname FROM employee join department on employee.deptno=department.deptno where employee.deptno ='$dept' order by employee.eid") or
                                    die(mysqli_error($conn));
                                }
                                $query1 = mysqli_query($conn, "SELECT ename FROM employee where ename like '%".$ename."%' and deptno='$dept'") or die(mysqli_error($conn));
                                    ...
                                    <li class="bg-white round boxShadow">
                                        <ul class="employeeListDesc clearfix align-middle">
                                            <li class="employeeImage clearfix"><img
                                                        ...
                                                        alt=""/><a
                                                        href="attendance-report-t.php?id=<?php echo $result['eid']; ?>"><label
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action = "#">
                    ...
                    <a href="attendance-book-department.php" class="btn btn-danger px-5 border-0 roundBtn">OK</a>
                </form>
            </div>
        </div>
    </div>
