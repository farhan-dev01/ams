                        ...
                        <form class="filterForm col-md-8" method="GET" action="#">
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input class="form-control round monthEnd dateIcon date-picker2" name="date" readonly type="text"
                                           value="<?php
                                           $d = explode(' ', date('F Y'));
                                           $month = $d[0];
                                           $year = $d[1];
            ...
            <form method="get" id = "form" >
                <section class="pageTitle row">
                    ...
                    <div class="col-md-4">
                        ...
                        <a href="edit-attendance-t.php" class="btn btn-primary roundBtn float-right addEmployee">EDIT/DELETE</a>
                    </div>
                </section><!-- Page Title-->
...
<script>
    ...
    $(document).ready(function () {
        ...
        curRecords.forEach(function(element) {
            try{
                console.log('a' + element[1] + element[0]);
