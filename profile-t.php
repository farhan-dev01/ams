...
<header>
    ...
    <section class="pageContent container h-75">
        ...
        $query = mysqli_query($conn, "SELECT * FROM teamhead_user where username='$ID'") or die(mysqli_error($conn));
                ...
                <div class="card-body">
                    ...
                    <form class="mt-4 align-items-center" enctype="multipart/form-data" action="#" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control round" required type="text" maxlength="20" id="name" name="name" placeholder="" value="<?php echo $result['name'] ?>" pattern="[a-zA-Z ]+">
                        </div>
                        <div class="form-group">
                            <label for="userName">Username</label>
                            <input class="form-control round" required  type="text" maxlength="10" id="userName" name="userName" placeholder="" value="<?php echo $result['username'] ?>">
                        </div>
                        <div class="form-group">
                            <label for="userPassword">Password</label>
                            <input class="form-control round" required type="text" maxlength="10" id="password" name="password" placeholder="" value="<?php echo $result['password'] ?>">
                        </div>
                        <div class="form-group">
...
else
{
    next:
        ...
        {
            $query="update teamhead_user set  username='$uname' ,name='$name',password='$password',email='$email',uimage='$image' where uid='$id'";
 ...
 $(\'#myModalsu\').modal({
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action = "attendance-book-department.php" method = "get">
 ...
 $(\'#myModalsu\').modal({
    ...
    keyboard: false
                ...
                $("#myModalsu").modal("show");
                    ...
                    $_SESSION['login_id2']=$uname;
                }     // header("Location: all-employee-list.php");
            }
        }
        else
        {
            $query="update teamhead_user set  username='$uname' ,name='$name',password='$password',email='$email',uimage='$img' where uid='$id'";
            if(!mysqli_query($conn,$query))
            {
                echo "Error";
            }
